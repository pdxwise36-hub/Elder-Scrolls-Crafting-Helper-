...
(function (global) {
  ...
  var MOTIFS = [
    ...
    { name: "Outlaw", stone: null, src: null },
    { name: "Order of the Hour", stone: null, src: null },
    { name: "Abah's Watch", stone: null, src: null },
    { name: "Assassin League", stone: null, src: null },
    ...
    { name: "Huntsman", stone: null, src: null },
    ...
    { name: "Trinimac", stone: null, src: "Wrothgar" },
    { name: "Malacath", stone: "Potash", src: "Wrothgar world bosses" },
    { name: "Dwarven", stone: null, src: null },
    { name: "Sapiarch", stone: null, src: "Summerset (drops)" },
    { name: "Dead-Water", stone: null, src: "Murkmire (drops)" },
    { name: "Honor Guard", stone: null, src: null },
    { name: "Welkynar", stone: null, src: "Cloudrest trial (Summerset)" },
    { name: "Dremora", stone: null, src: "Rewards for the Worthy (Cyrodiil)" },
    { name: "Silver Dawn", stone: null, src: null },
    { name: "Order of Diagna", stone: null, src: null },
    { name: "Coldsnap", stone: null, src: null },
    { name: "Sunspire", stone: null, src: "Sunspire trial (Elsweyr)" },
    { name: "Frostcaster", stone: null, src: null },
    { name: "Apostle", stone: null, src: null },
    { name: "Meridian", stone: null, src: null }
  ];
